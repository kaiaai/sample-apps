# Tank-Style Gamepad
Virtual tank-style gamepad to control your robot manually. There are two levers, one controlling the left motor and one controlling the right motor.
...
## Tank-Style Gamepad Code Overview
```js
